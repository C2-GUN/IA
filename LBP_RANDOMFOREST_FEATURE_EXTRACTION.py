# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 14:22:06 2019
...
joblib.dump(clf, 'D:\Documents\OPENCV\MODELS\LBP_RANDOMFOREST_MODEL_'+str(metrics.accuracy_score(y_test, y_pred))+'.pkl')
end = timer()
...
plt.savefig('CONFUSION_MATRIX_LBP_RANDOMFOREST')