# -*- coding: utf-8 -*-
"""
Created on Mon Oct 14 23:11:53 2019
...
joblib.dump(clf, 'D:\Documents\OPENCV\MODELS\HAAR_SVM_MODEL_'+str(metrics.accuracy_score(y_test, y_pred))+'.pkl')
end = timer()
...
plt.savefig('CONFUSION2_MATRIX_HAAR_SVM')
