# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 00:26:57 2019
...
RandomForest = joblib.load('D:\Documents\OPENCV\MODELS\HAAR_RANDOMFOREST_MODEL_0.9501557632398754.pkl')
...
predic = RandomForest.predict(np.array([features]))
print(predic[0])
end = timer()
